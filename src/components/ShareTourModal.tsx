...
export const ShareTourModal: React.FC<ShareTourModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/75 backdrop-blur-sm p-4 overflow-y-auto">
      <div className="relative w-full max-w-2xl bg-white dark:bg-slate-900 rounded-2xl shadow-2xl border border-slate-200 dark:border-slate-800 overflow-hidden my-6 flex flex-col transition-colors">
        {/* Header */}
        <div className="p-4 sm:p-5 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between bg-slate-900 dark:bg-slate-950 text-white">
          ...
          <div>
              ...
              <div className="flex items-center gap-1 bg-slate-100 dark:bg-slate-800 p-1 rounded-lg text-xs">
                <button
                  ...
                  className={`px-2.5 py-1 rounded font-medium transition-colors cursor-pointer ${
                    cardTheme === 'cyber' ? 'bg-slate-900 dark:bg-amber-500 text-amber-400 dark:text-slate-950 font-bold' : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white'
                  }`}
                >
                  Cyber AR
                </button>
                <button
                  ...
                  className={`px-2.5 py-1 rounded font-medium transition-colors cursor-pointer ${
                    cardTheme === 'postcard' ? 'bg-amber-100 dark:bg-amber-950 text-amber-900 dark:text-amber-300 font-bold' : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white'
                  }`}
                >
                  Postcard
                </button>
                <button
                  ...
                  className={`px-2.5 py-1 rounded font-medium transition-colors cursor-pointer ${
                    cardTheme === 'midnight' ? 'bg-black text-white font-bold' : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white'
                  }`}
                >
                  Midnight
                </button>
            ...
            <div className="mt-3 flex justify-end">
              <button
                ...
                className="flex items-center gap-1.5 px-3.5 py-2 rounded-xl bg-slate-900 dark:bg-slate-800 hover:bg-slate-800 dark:hover:bg-slate-700 text-white text-xs font-semibold shadow-xs transition-colors disabled:opacity-50 cursor-pointer"
              >
          ...
          <div className="border-t border-slate-200 dark:border-slate-800 pt-5">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                readOnly
                value={shareUrl}
                className="flex-1 bg-slate-100 dark:bg-slate-800 border border-slate-300 dark:border-slate-700 rounded-xl px-3 py-2 text-xs font-mono text-slate-700 dark:text-slate-200 select-all focus:outline-none focus:ring-2 focus:ring-amber-500"
              />
              <button
                id="copy-share-link-btn"
                onClick={handleCopyLink}
                className="flex items-center gap-1 px-4 py-2 rounded-xl bg-amber-500 hover:bg-amber-400 text-slate-950 font-bold text-xs transition-colors shrink-0 cursor-pointer"
              >
                {copied ? (
                  <>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2.5">
              ...
              {typeof navigator !== 'undefined' && 'share' in navigator && (
                <button
                  ...
                  className="p-2.5 rounded-xl border border-slate-200 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800 text-xs font-semibold text-slate-800 dark:text-slate-200 flex items-center justify-center gap-2 transition-colors cursor-pointer"
                >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-2.5 rounded-xl border border-slate-200 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800 text-xs font-semibold text-emerald-700 dark:text-emerald-400 flex items-center justify-center gap-2 transition-colors cursor-pointer"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-2.5 rounded-xl border border-slate-200 dark:border-slate-800 hover:bg-slate-50 dark:hover:bg-slate-800 text-xs font-semibold text-sky-700 dark:text-sky-400 flex items-center justify-center gap-2 transition-colors cursor-pointer"
              >
